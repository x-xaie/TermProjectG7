...
The dataset for this project, Body signal of smoking, is from Kaggle [[link]](https://www.kaggle.com/datasets/kukuroo3/body-signal-of-smoking). It is taken from the 1994 US Census database and contains census and income information for about 50,000 individuals. Based on census features, the machine learning task is to predict if the income of an individual is above $50,000 or not (binary classification).
